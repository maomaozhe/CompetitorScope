...
// ── Test 2: HITL mode toggle visible ─────────────────────────────────
...
// ── Test 3: Submit analysis in auto mode ─────────────────────────────
let runId = null;
...
// ── Test 5: AgentFlow agents visible ────────────────────────────────
...
if (runId) {
  ...
  try {
    ...
    console.log(`  ✓ DELETE cancelled run: ${JSON.stringify(data)}`);
